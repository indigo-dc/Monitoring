 ...
 * lifecycle by using the OCCI API exposed by a Cloud provider. It keeps information about each
...
public class OpenStackProbeResult {
  ...
  /**
   * This is a constructor that takes as input the global values for the VMs lifecycle operation
   * (create, inspect and delete VM).
   * 
  ...
  /**
   * This method sets the global values of the monitoring operation, as it represents a kind of
   * aggregation of monitored values for each operation.
   * 
   * @param availability 1 if all the operations were available, 0 if not
   * @param result It is a global HTTP response code, the most problematic one.
   * @param responseTime Sum of the response time of all calls, in milliseconds.
  ...
  /**
   * This method sets the monitoring information related to the operation for creating a VM.
   * 
  ...
  /**
   * This method sets the monitoring information related to the operation for inspecting a VM.
   * 
  ...
  /**
   * This method sets the monitoring information related to the operation for deleting a VM.
   * 
  ...
  /**
   * It retrieves the response time as result of summing up all the operations performed for the
   * monitoring.
   * 
