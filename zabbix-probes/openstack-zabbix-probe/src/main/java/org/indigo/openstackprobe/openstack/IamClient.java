...
//    PropertiesManager myProp = new PropertiesManager();
    String iamUser = PropertiesManager.getProperty(OpenstackProbeTags.OPENSTACK_USER);
    String iamPwd = PropertiesManager.getProperty(OpenstackProbeTags.OPENSTACK_PASSWORD);
    ...
    Client client = JerseyClientBuilder.newClient(cc);
    
    // Prepare access URLs
    String baseIamUrl = iamLocation;             
  }
