...
//
///**
// * This class is in charge of carrying out the monitoring process for the Openstack API of a
// * concrete provider. It covers the whole lifecycle (create, inspect and delete VM) and it sends the
// * corresponding results to the Zabbix sender. * Since it extends the Thread class, it is expected
// * to have several instances running in parallel.
// * 
// * @author Reply
// *
// */
...
//      LogManager.getLogger(MonitoringThread.class);
//
//  /**
...
//   * 
//   * @param senderMock
//   *          Mock for the Zabbix sender
//   * @param OpenstackMock
//   *          Mock for the Openstack client
//   * @param providerId
//   *          Provider identifier
//   */
...
//
//  /**
//   * This method executes the actions required for the monitoring process (perform the expected
//   * operations on the Openstack API and send the metrics gathered to Zabbix).
//   */
//  @Override
//  public void run() {
//    try {
...
//      mySender.send(result);
//    } catch (Exception ex) {
//      log.info("Failure when monitoring the provider" + provider + "!" + ex.getMessage());
//    }
//
