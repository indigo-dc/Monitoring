...
public class KeystoneClient {
  ...
  public KeystoneClient(String location) {
    if (location.endsWith("/v3/v3")) {
      ...
      throw new IllegalArgumentException("Error generating Keystone client.\nOpenstack endpoint <"
          + location + "> provided but only v3 endpoints are supported");
    }
   ...
   */
  public String getScopedToken(String accessToken, String projectName, String provider,
      String protocol) {
      ...
      if (unscopedToken != null) {
        ...
        if (projects != null) {
          ...
          if (found != null) {
            ...
            return getTokenHeader(keystoneClient
                .getScopedToken(new KeystoneScopedTokenRequest(unscopedToken, found.getId())));
