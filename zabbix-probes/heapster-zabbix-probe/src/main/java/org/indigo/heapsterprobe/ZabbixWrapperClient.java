...
public class ZabbixWrapperClient {
   ...
   * from the config file and it construcs the base URL for the Wrapper client.
   */
  ...
  /**
   * This method accesses the Wrapper API in order to get the host information by its name. It
   * is focused on finding only Containers. In case it cannot find it, it will return a 'false'
   * value.
  ...
  /**
   * This method accesses the Wrapper API in order to get the host information by its name. It
   * is focused on finding pods. In case it cannot find it, it will return a 'false' value.
