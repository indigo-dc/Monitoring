...
@JsonPropertyOrder({ "hostid", "proxy_hostid", "host", "status", "disable_until", "error",
    "available", "errors_from", "lastaccess", "ipmi_authtype", "ipmi_privilege", "ipmi_username",
    ...
    "parentTemplates", "items", "inventory", "groups" })
public class ZabbixMonitoredHostResponseV24 {
